...
# **get_request**
> GetUserRequests200Response get_request(take=take, skip=skip, filter=filter, sort=sort, requested_by=requested_by)
...
# **get_request_count**
> GetRequestCount200Response get_request_count()
