...
class GetDiscoverTvNetworkByNetworkId200Response(BaseModel):
    ...
    __properties = ["page", "totalPages", "totalResults", "network", "results"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDiscoverTvNetworkByNetworkId200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDiscoverTvNetworkByNetworkId200Response:
        """Create an instance of GetDiscoverTvNetworkByNetworkId200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetDiscoverTvNetworkByNetworkId200Response.parse_obj(obj)

        _obj = GetDiscoverTvNetworkByNetworkId200Response.parse_obj({
            "page": obj.get("page"),
