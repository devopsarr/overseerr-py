...
class GetServiceSonarrBySonarrId200Response(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    server: Optional[SonarrSettings]
    profiles: Optional[ServiceProfile]
    additional_properties: Dict[str, Any] = {}
    __properties = ["server", "profiles"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetServiceSonarrBySonarrId200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetServiceSonarrBySonarrId200Response:
        """Create an instance of GetServiceSonarrBySonarrId200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetServiceSonarrBySonarrId200Response.parse_obj(obj)

        _obj = GetServiceSonarrBySonarrId200Response.parse_obj({
