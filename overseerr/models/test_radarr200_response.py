...
class TestRadarr200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestRadarr200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestRadarr200Response:
        """Create an instance of TestRadarr200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TestRadarr200Response.parse_obj(obj)

        _obj = TestRadarr200Response.parse_obj({
