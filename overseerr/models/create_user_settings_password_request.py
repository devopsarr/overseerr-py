...
class CreateUserSettingsPasswordRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateUserSettingsPasswordRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateUserSettingsPasswordRequest:
        """Create an instance of CreateUserSettingsPasswordRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateUserSettingsPasswordRequest.parse_obj(obj)

        _obj = CreateUserSettingsPasswordRequest.parse_obj({
