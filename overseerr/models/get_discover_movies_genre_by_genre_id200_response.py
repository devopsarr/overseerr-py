...
class GetDiscoverMoviesGenreByGenreId200Response(BaseModel):
    ...
    __properties = ["page", "totalPages", "totalResults", "genre", "results"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDiscoverMoviesGenreByGenreId200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDiscoverMoviesGenreByGenreId200Response:
        """Create an instance of GetDiscoverMoviesGenreByGenreId200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetDiscoverMoviesGenreByGenreId200Response.parse_obj(obj)

        _obj = GetDiscoverMoviesGenreByGenreId200Response.parse_obj({
            "page": obj.get("page"),
