...
class GetServiceRadarrByRadarrId200Response(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    server: Optional[RadarrSettings]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetServiceRadarrByRadarrId200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetServiceRadarrByRadarrId200Response:
        """Create an instance of GetServiceRadarrByRadarrId200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetServiceRadarrByRadarrId200Response.parse_obj(obj)

        _obj = GetServiceRadarrByRadarrId200Response.parse_obj({
