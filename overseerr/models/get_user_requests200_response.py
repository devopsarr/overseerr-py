...
class GetUserRequests200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetUserRequests200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetUserRequests200Response:
        """Create an instance of GetUserRequests200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetUserRequests200Response.parse_obj(obj)

        _obj = GetUserRequests200Response.parse_obj({
