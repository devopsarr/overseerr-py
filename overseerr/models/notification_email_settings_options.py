...
class NotificationEmailSettingsOptions(BaseModel):
    ...
    smtp_port: Optional[float]
    secure: Optional[bool]
    ignore_tls: Optional[bool]
    require_tls: Optional[bool]
    auth_user: Optional[str]
    auth_pass: Optional[str]
    allow_self_signed: Optional[bool]
    additional_properties: Dict[str, Any] = {}
    __properties = ["emailFrom", "senderName", "smtpHost", "smtpPort", "secure", "ignoreTls", "requireTls", "authUser", "authPass", "allowSelfSigned"]
