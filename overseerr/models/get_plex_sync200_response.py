...
class GetPlexSync200Response(BaseModel):
    ...
    current_library: Optional[PlexLibrary]
    libraries: Optional[List]
    additional_properties: Dict[str, Any] = {}
    __properties = ["running", "progress", "total", "currentLibrary", "libraries"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPlexSync200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPlexSync200Response:
        """Create an instance of GetPlexSync200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetPlexSync200Response.parse_obj(obj)

        _obj = GetPlexSync200Response.parse_obj({
