...
class CreateRequestRequest(BaseModel):
    ...
    media_id: Optional[float]
    tvdb_id: Optional[float]
    seasons: Optional[CreateRequestRequestSeasons]
    is4k: Optional[bool]
    ...
    __properties = ["mediaType", "mediaId", "tvdbId", "seasons", "is4k", "serverId", "profileId", "rootFolder", "languageProfileId", "userId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRequestRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRequestRequest:
        """Create an instance of CreateRequestRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateRequestRequest.parse_obj(obj)

        _obj = CreateRequestRequest.parse_obj({
            "media_type": obj.get("mediaType"),
            "media_id": obj.get("mediaId"),
            "tvdb_id": obj.get("tvdbId"),
            "seasons": CreateRequestRequestSeasons.from_dict(obj.get("seasons")) if obj.get("seasons") is not None else None,
            "is4k": obj.get("is4k"),
