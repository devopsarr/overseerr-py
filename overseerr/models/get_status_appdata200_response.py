...
class GetStatusAppdata200Response(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    app_data: Optional[bool]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetStatusAppdata200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetStatusAppdata200Response:
        """Create an instance of GetStatusAppdata200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetStatusAppdata200Response.parse_obj(obj)

        _obj = GetStatusAppdata200Response.parse_obj({
