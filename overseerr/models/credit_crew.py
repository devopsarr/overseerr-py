...
class CreditCrew(BaseModel):
    ...
    __properties = ["id", "originalLanguage", "episodeCount", "overview", "originCountry", "originalName", "voteCount", "name", "mediaType", "popularity", "creditId", "backdropPath", "firstAirDate", "voteAverage", "genreIds", "posterPath", "originalTitle", "video", "title", "adult", "releaseDate", "department", "job", "mediaInfo"]
