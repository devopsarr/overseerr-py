...
class GetDiscoverMovies200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDiscoverMovies200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDiscoverMovies200Response:
        """Create an instance of GetDiscoverMovies200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetDiscoverMovies200Response.parse_obj(obj)

        _obj = GetDiscoverMovies200Response.parse_obj({
            "page": obj.get("page"),
