...
class GetMedia200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetMedia200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetMedia200Response:
        """Create an instance of GetMedia200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetMedia200Response.parse_obj(obj)

        _obj = GetMedia200Response.parse_obj({
