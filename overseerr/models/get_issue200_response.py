...
class GetIssue200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetIssue200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetIssue200Response:
        """Create an instance of GetIssue200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetIssue200Response.parse_obj(obj)

        _obj = GetIssue200Response.parse_obj({
